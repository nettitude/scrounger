...
class Module(BaseModule):
    meta = {
        "author": "RDC",
        "description": "Checks if a binary uses weak SSL ciphers",
        "certainty": 50
    }
    ...
    _regex = r"kCFStreamSocketSecurityLevel|kSSLProtocol|kTLSProtocol|\
kDTLSProtocol|SSLCipherSuite"

    def run(self):
        result = {
            "title": "Application Uses Weak SSL Ciphers",
            "details": "",
            "severity": "Low",
            "report": False
        }
